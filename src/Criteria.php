...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'user_id', 'fingerprint_hash', 'attributes', 'risk_score', 'first_seen', 'last_seen', 'last_ip_hash', 'last_ip_key_version' ];
    }
...
{
    return [ 'id', 'user_id', 'risk_score', 'first_seen', 'last_seen', 'last_ip_key_version' ];
}
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\DeviceFingerprints\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\DeviceFingerprints\Definitions::softDeleteColumn();
