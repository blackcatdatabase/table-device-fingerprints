...
namespace BlackCat\Database\Packages\DeviceFingerprints;
...
use BlackCat\Database\Packages\DeviceFingerprints\Repository\DeviceFingerprintRepository as GeneratedRepository;
...
{
  private DeviceFingerprintRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof DeviceFingerprintRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected DeviceFingerprintRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\DeviceFingerprints\Dto\DeviceFingerprintDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\DeviceFingerprints\Dto\DeviceFingerprintDto|null { return $this->repo->getById($id, $asDto); }
