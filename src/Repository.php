...
use BlackCat\Database\Packages\DeviceFingerprints\Repository\DeviceFingerprintRepository;
...
{
    private DeviceFingerprintRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new DeviceFingerprintRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\DeviceFingerprints\Dto\DeviceFingerprintDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\DeviceFingerprints\Dto\DeviceFingerprintDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\DeviceFingerprints\Dto\DeviceFingerprintDto|null
    {
