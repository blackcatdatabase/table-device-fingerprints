...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'user_id', 'fingerprint_hash', 'fingerprint_hash_key_version', 'attributes', 'risk_score', 'first_seen', 'last_seen', 'last_ip_hash', 'last_ip_key_version', 'created_at', 'updated_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'fingerprint_hash' ], [ 'id' ] ]; }

    /** @return string[] JSON columns for casts/operations */
    public static function jsonColumns(): array { return [ 'attributes' ]; }

    /** @return string[] List of numeric columns (generator heuristic; no runtime DB queries). */
    public static function intColumns(): array { return [ 'id', 'user_id', 'risk_score' ]; }
