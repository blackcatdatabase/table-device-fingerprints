...
namespace BlackCat\Database\Packages\DeviceFingerprints\Mapper;

use BlackCat\Database\Packages\DeviceFingerprints\Dto\DeviceFingerprintDto;
use BlackCat\Database\Packages\DeviceFingerprints\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO DeviceFingerprintDto:
...
final class DeviceFingerprintDtoMapper
{
    ...
    private const COL_TO_PROP = [ 'id' => 'id', 'user_id' => 'userId', 'fingerprint_hash' => 'fingerprintHash', 'fingerprint_hash_key_version' => 'fingerprintHashKeyVersion', 'attributes' => 'attributes', 'risk_score' => 'riskScore', 'first_seen' => 'firstSeen', 'last_seen' => 'lastSeen', 'last_ip_hash' => 'lastIpHash', 'last_ip_key_version' => 'lastIpKeyVersion', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'user_id', 'risk_score' ];
    /** @var string[] */
    private const FLOAT_COLS  = [];
    /** @var string[] */
    private const JSON_COLS   = [ 'attributes' ];
    /** @var string[] */
    private const DATE_COLS   = [ 'first_seen', 'last_seen', 'created_at', 'updated_at' ];
    /** @var string[] */
    private const BIN_COLS    = [ 'fingerprint_hash', 'last_ip_hash' ];
     ...
     */
    public static function fromRow(array $row): DeviceFingerprintDto
    {
        /** @var DeviceFingerprintDto */
    ...
    public static function fromRowOrNull(?array $row): ?DeviceFingerprintDto
    {
     ...
     *
     * @param DeviceFingerprintDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(DeviceFingerprintDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(DeviceFingerprintDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(DeviceFingerprintDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,DeviceFingerprintDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,DeviceFingerprintDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(DeviceFingerprintDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,DeviceFingerprintDto>
     */
