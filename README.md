...
| Pkg folder | [packages\device-fingerprints](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\device-fingerprints) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package device-fingerprints -Apply
