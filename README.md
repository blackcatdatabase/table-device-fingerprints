...
- Pkg folder: [packages\device-fingerprints](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\device-fingerprints)
...
graph LR
  ...
  device_fingerprints["device_fingerprints"]:::center
  device_fingerprints -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package device-fingerprints -Apply
